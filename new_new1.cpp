...
dissect_sccp_called_calling_param(tvbuff_t *tvb,
	guint length, gboolean called, SS7_target * target)
{
...
static void
dissect_sccp_called_param(tvbuff_t *tvb, guint length, SS7_target* target)
{
	dissect_sccp_called_calling_param(tvb, length, TRUE, target);
}


static void
dissect_sccp_calling_param(tvbuff_t *tvb, guint length, SS7_target* target)
{
	dissect_sccp_called_calling_param(tvb, length, FALSE, target);
}
...
static void
dissect_sccp_class_param(tvbuff_t *tvb, guint length)
{
	guint8      msg_class;
	...
	guint16 parameter_length, SS7_target* target)
{
	...
	case PARAMETER_CALLED_PARTY_ADDRESS:
		...
		dissect_sccp_called_param(parameter_tvb, parameter_length, target);
		break;

	case PARAMETER_CALLING_PARTY_ADDRESS:
		dissect_sccp_calling_param(parameter_tvb, parameter_length, target);
		break;
	...
	case PARAMETER_CLASS:
		dissect_sccp_class_param(parameter_tvb, parameter_length);
		break;
